...
function Shop({loks,lokPass,kids,uiTheme,ownedThemes,effect,ownedEffects,ownedTiers,ccTier,cosmetics,owned,onBuyCosmetic,setKids,onBuyPass,onTheme,onEffect,onTier,onCc,founder=false,onFounderJoin,say}){
