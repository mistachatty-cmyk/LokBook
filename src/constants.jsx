...
export const LOK_REGIONS = [
  { id: "demo-grid", name: "Sandbox City", status: "live", synthetic: true,
    ...
    landmark: { lat: 40.710, lng: -74.0075, name: "The Sandbox" },
    blurb: "A generated test city. Not a real place — for trying the tools." },
  { id: "nyc-midtown", name: "Midtown Manhattan", status: "live",
    bbox: [40.745, -74.000, 40.770, -73.970], pack: "/regions/nyc-midtown.json",
    landmark: { lat: 40.7580, lng: -73.9855, name: "Times Square" },
    blurb: "Times Square, Bryant Park, the Garment District." },
  { id: "london-city", name: "City of London", status: "live",
    bbox: [51.505, -0.110, 51.525, -0.070], pack: "/regions/london-city.json",
    landmark: { lat: 51.5138, lng: -0.0984, name: "St Paul's Cathedral" },
    blurb: "The Square Mile." },
  { id: "paris-centre", name: "Paris Centre", status: "live",
    bbox: [48.850, 2.320, 48.870, 2.360], pack: "/regions/paris-centre.json",
    landmark: { lat: 48.8530, lng: 2.3499, name: "Notre-Dame" },
    blurb: "Île de la Cité and the Marais." },
  { id: "tokyo-shibuya", name: "Shibuya", status: "live",
    bbox: [35.655, 139.690, 35.670, 139.710], pack: "/regions/tokyo-shibuya.json",
    landmark: { lat: 35.6595, lng: 139.7005, name: "Shibuya Scramble" },
    blurb: "The scramble and everything around it." },
  { id: "sf-downtown", name: "Downtown San Francisco", status: "live",
    bbox: [37.780, -122.410, 37.800, -122.390], pack: "/regions/sf-downtown.json",
    landmark: { lat: 37.7955, lng: -122.3937, name: "Ferry Building" },
    blurb: "Market Street and the Financial District." },
  { id: "chicago-loop", name: "The Loop", status: "live",
    bbox: [41.870, -87.645, 41.890, -87.620], pack: "/regions/chicago-loop.json",
    landmark: { lat: 41.8789, lng: -87.6359, name: "Willis Tower" },
    blurb: "Chicago's downtown, under the L tracks." },
  { id: "dubai-marina", name: "Dubai Marina", status: "live",
    bbox: [25.070, 55.130, 25.090, 55.150], pack: "/regions/dubai-marina.json",
    landmark: { lat: 25.0805, lng: 55.1403, name: "Marina Towers" },
    blurb: "A canyon of towers around the water." },
  { id: "hk-central", name: "Hong Kong Central", status: "live",
    bbox: [22.275, 114.150, 22.290, 114.170], pack: "/regions/hk-central.json",
    landmark: { lat: 22.2850, lng: 114.1580, name: "Two IFC" },
    blurb: "The densest skyline on the planet." },
  { id: "sydney-cbd", name: "Sydney CBD", status: "live",
    bbox: [-33.875, 151.200, -33.855, 151.220], pack: "/regions/sydney-cbd.json",
    landmark: { lat: -33.8568, lng: 151.2153, name: "Opera House" },
    blurb: "Circular Quay to Town Hall." },
  { id: "chattanooga", name: "Chattanooga", status: "live",
    bbox: [35.040, -85.320, 35.065, -85.295], pack: "/regions/chattanooga.json",
    landmark: { lat: 35.0576, lng: -85.3097, name: "Walnut Street Bridge" },
    blurb: "Downtown, the riverfront and the bridges." },
  // --- the expansion pipeline -------------------------------------------
  // Adding a city is: bake it (`node scripts/bake-pmtiles.mjs <id>`), then
  // change one word here. These rows exist so the queue is visible in the UI
  // and so `verify:regions` keeps proving an unbaked region never claims
  // coverage — a "soon" row must never satisfy regionAt().
  { id: "berlin-mitte", name: "Berlin Mitte", status: "live",
    bbox: [52.510, 13.375, 52.530, 13.410], pack: "/regions/berlin-mitte.json",
    landmark: { lat: 52.5163, lng: 13.3777, name: "Brandenburg Gate" },
    blurb: "Unter den Linden and the museum island." },
  { id: "seoul-gangnam", name: "Gangnam", status: "live",
    bbox: [37.495, 127.020, 37.515, 127.050], pack: "/regions/seoul-gangnam.json",
    landmark: { lat: 37.5045, lng: 127.0490, name: "COEX" },
    blurb: "Teheran-ro, end to end." },
  { id: "saopaulo-centro", name: "São Paulo Centro", status: "live",
    bbox: [-23.560, -46.650, -23.540, -46.625], pack: "/regions/saopaulo-centro.json",
    landmark: { lat: -23.5450, lng: -46.6388, name: "Edifício Copan" },
    blurb: "Avenida Paulista down to the Vale do Anhangabaú." },
  { id: "lagos-island", name: "Lagos Island", status: "live",
    bbox: [6.440, 3.390, 6.460, 3.420], pack: "/regions/lagos-island.json",
    landmark: { lat: 6.4541, lng: 3.3947, name: "Marina" },
    blurb: "The Marina and Broad Street." },
  { id: "mumbai-fort", name: "Mumbai Fort", status: "soon",
    bbox: [18.920, 72.825, 18.945, 72.845], pack: "/regions/mumbai-fort.json",
    landmark: { lat: 18.9220, lng: 72.8347, name: "Gateway of India" },
    blurb: "The Fort district and the harbour front." },
  { id: "mexico-centro", name: "Centro Histórico", status: "soon",
    bbox: [19.425, -99.145, 19.445, -99.125], pack: "/regions/mexico-centro.json",
    landmark: { lat: 19.4326, lng: -99.1332, name: "Zócalo" },
    blurb: "The Zócalo out to the Alameda." },
  { id: "cairo-downtown", name: "Downtown Cairo", status: "soon",
    bbox: [30.040, 31.230, 30.060, 31.255], pack: "/regions/cairo-downtown.json",
    landmark: { lat: 30.0444, lng: 31.2357, name: "Tahrir Square" },
    blurb: "Tahrir, Talaat Harb and the corniche." },
];
