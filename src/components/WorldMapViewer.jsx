          ...
          {status === 'ready' && (
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <div className="lok-chip-scroll" style={{ display: 'flex', gap: 6, overflowX: 'auto' }}>
                {/* 3D City leads — it is what this screen is actually for and
                    what the user asked to be first. Then the real map sources,
                    which are what make zoom detail and extrusion possible.
                    Skin is a flat decorative texture with no geographic tiles,
                    so picking it opts OUT of all of that: it goes last. */}
