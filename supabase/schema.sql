...
-- 7. Follows table — who follows whom
...
-- 8. Bookmarks table — who bookmarked which post
...
-- 9. Reactions table — per-user reactions on posts
...
-- Add following and bookmarks quick-lookup columns to lok_accounts
